...
export const getPosts = async (dispatch, token) => {
  const response = await fetch(
    `https://photogramapp.vercel.app/posts?isSharable=true`,
    {
      method: "GET",
...
export const getUserPosts = async (dispatch, token, userId) => {
  const response = await fetch(
    `https://photogramapp.vercel.app/posts/${userId}/posts`,
    {
      method: "GET",
      headers: { Authorization: `Bearer ${token}` },
    }
...
export const generatePDF = async (token, loggedInUserId) => {
  const response = await fetch(
    `https://photogramapp.vercel.app/posts/${loggedInUserId}/posts`,
    {
      method: "GET",
      headers: { Authorization: `Bearer ${token}` },
    }
